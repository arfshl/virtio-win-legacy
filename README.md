...
virtio-win drivers, spice-agent, and qemu-guest-agent for Windows XP, Vista, and 7
...
# Download
#### virtio-win drivers, spice-agent

https://github.com/arfshl/virtio-win-legacy/releases/download/virtio-win-legacy/virtio-win-legacy.iso

#### Execute spice-guest-tools-0.141.exe and it will install virtio drivers and spice agent

#### qemu-guest-agent 

https://github.com/arfshl/virtio-win-legacy/releases/download/virtio-win-legacy/qemu-ga-win-100.0.0.0-3.el7ev.iso

#### floppy image (.vfd) for windows xp/server 2003 virtio-blk

https://github.com/arfshl/virtio-win-legacy/releases/download/virtio-win-legacy/virtio-win-0.1.190_amd64.vfd

https://github.com/arfshl/virtio-win-legacy/releases/download/virtio-win-legacy/virtio-win-0.1.190_x86.vfd
...
https://github.com/arfshl/virtio-win-legacy/releases/download/virtio-win-legacy/SOURCES.txt
